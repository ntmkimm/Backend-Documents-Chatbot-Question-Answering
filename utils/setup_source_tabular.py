...
EXAMPLE_SOURCE_FILE = "utils/description_tabular.txt"
...
def create_text_source(notebook_id: str, content: str, transformation_id: str) -> str:
    ...
    data = {
        ...
        "type": "tabular",
        "content": content,
        "file_path": "utils/Youtube Influencer Analysis - Updated.csv",
        "transformations": [transformation_id],
        "embed": False,
        "delete_source": False
    }
    
    response = make_request('POST', '/sources_tabular', data)
...
def verify_final_setup(notebook_id: str):
    ...
    try:
        sources = make_request('GET', '/sources_tabular')
